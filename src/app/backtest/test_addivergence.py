"""
Script de test pour AdDivergenceStrategy (divergence haussière prix / Accumulation-Distribution).
...
def main():
    ...
    print("=" * 60)
    print("BACKTEST - AdDivergenceStrategy (A/D divergence haussière)")
    print("=" * 60)
    ...
    # AdDivergenceBTWrapper a une signature de params différente des wrappers
