"""
Script de test pour RangeBollingerStrategy (mean reversion Bollinger Bands + RSI).
...
from range_bollinger_bt_wrapper import RangeBollingerBTWrapper
...
def main():
    parser = argparse.ArgumentParser(description="Backtest RangeBollingerStrategy")
    ...
    print("=" * 60)
    print("BACKTEST - RangeBollingerStrategy (A/D divergence haussière)")
    print("=" * 60)
    ...
    engine = BacktestEngine(
        strategy_cls=RangeBollingerBTWrapper,
        start_date=start_date,
        end_date=end_date,
        initial_cash=100000
    )

    # RangeBollingerBTWrapper a une signature de params différente des wrappers
